(function ($) {
	...
	{
		var $post_social_share_display = $( 'input[name="social_share_inherit"]' ).closest( '.field' ).next( '.field' );
		...
		function toggle_post_social_share_section() {
		 ...
		 $( 'input[name="social_share_inherit"]' ).on( 'click', toggle_post_social_share_section );
