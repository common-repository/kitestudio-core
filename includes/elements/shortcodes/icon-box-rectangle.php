...
/*  Icon-Box-Rectangle
/*-----------------------------------------------------------------------------------*/
if ( ! function_exists( 'kite_sc_iconbox_rectangle' ) ) {
	function kite_sc_iconbox_rectangle( $atts, $content = null ) {
		extract(
			shortcode_atts(
				array(
					'title'                => '',
				...
				<span class="glyph <?php echo esc_attr( $icon ); ?>" style="
												   <?php
													if ( strlen( esc_attr( $icon_border_color ) ) ) {
														?>
					border-color: <?php echo esc_attr( $icon_border_color ); ?>;background-color: <?php echo esc_attr( $icon_border_color ); ?>;
														<?php
													} if ( strlen( esc_attr( $icon_color ) ) ) {
														?>
					 color: <?php echo esc_attr( $icon_color ); ?>; <?php } ?>"></span>
			</div>
