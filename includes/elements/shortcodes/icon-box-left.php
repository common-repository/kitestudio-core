...
/*  Icon-Box-left
/*-----------------------------------------------------------------------------------*/
if ( ! function_exists( 'kite_sc_iconbox_left' ) ) {
	function kite_sc_iconbox_left( $atts, $content = null ) {
		extract(
			shortcode_atts(
				array(
					'title'                => '',
		...
		wp_enqueue_style( 'kite-iconbox-left' );
		$has_title = '' != $title;
		...
		<div id="<?php echo esc_attr( $id ); ?>" class="<?php echo esc_attr( implode( ' ', $class ) ); ?>"
							<?php
							if ( strlen( esc_attr( $icon_animation ) ) ) {
								?>
				...
				<span class="glyph <?php echo esc_attr( $icon ); ?>"
												   <?php
													if ( strlen( esc_attr( $icon_color ) ) ) {
														?>
					style="color: <?php echo esc_attr( $icon_color ); ?>;" <?php } ?>></span>
			</div>
			<div class="content-wrap">
				<?php if ( esc_attr( $has_title ) ) { ?>
